...
Files for: MAME32 version .88u4(rev. 1)

The included files are as follows:

Version.ini:    This file replaces the one mame32 comes with.
                It tracks game name changes for accuracy.
...
Mature.ini:     Games rated for adult content.
